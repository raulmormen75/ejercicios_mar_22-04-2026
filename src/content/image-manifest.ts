...
Comparar visualmente los tres escenarios con una composición mucho más limpia y alineada. Usar una columna izquierda con cuatro ideas clave del cierre y, a la derecha, tres tarjetas verticales del mismo tamaño: una para simetría total, otra para ventaja por costos y otra para simetría interior. Cada tarjeta debe resumir pocas etiquetas, un mini diagrama de calle con A, B y x*, y una lectura breve de qué cambia o qué se conserva. Priorizar rejilla clara, espaciado uniforme y comparación rápida entre columnas.`,
  ...
  },
  {
    ...
    placement: "after-section",
    prompt: `${whiteboardVisualDirection}
Mostrar que la versión cuadrática es una ruta separada y cambia la escala del problema. Usar una columna izquierda con cinco advertencias breves y, a la derecha, una comparación limpia entre un bloque lineal td y otro cuadrático td², con una nota visual de que cambia la sensibilidad, las unidades importan y los resultados pueden crecer mucho. Priorizar lectura de anexo metodológico, no de solución completa.`,
    ...
    sketchLines: [
      ...
      "4. precios pueden crecer mucho",
      "5. no mezclar con lineal",
    ],
  },
  {
    id: "tres-empresas",
    ...
    placement: "after-section",
    prompt: `${whiteboardVisualDirection}
Mostrar tres empresas sobre una calle y resaltar con mucha claridad que la firma central recibe mercado por ambos lados. Usar una columna izquierda con cinco notas breves y, a la derecha, una calle horizontal limpia con F1, F2 y F3, dos fronteras laterales y una marca fuerte de la empresa central. Añadir una caja breve con q2 > q1 y q2 > q3 y una frase final de que, con el mismo precio, la firma central vende más.`,
